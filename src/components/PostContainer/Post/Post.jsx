    ...
    return (
        <div className="post">
            <div className="post__header">
                <img className="post__teacher-image" src="https://images.pexels.com/photos/3623309/pexels-photo-3623309.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" alt=""/>
                <div className="post__teacher-description">
                    <div>
                        ...
                        <button className="post__button">Add to bookmarks</button>
                    </div>
